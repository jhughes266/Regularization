...
for epochNum in range(epochs):
    ...
    for batchNum in range(batchesPerEpoch):
        ...
        _, graphData = L4.DisplayInfo(display=True, modelWeights=modelWeights, lam= lam, L1=True)
        #grapher.UpdatePlot(graphData)
        L3.GradientStep(L1=True, lam=lam)
        L2.GradientStep(L1=True, lam=lam)
        L1.GradientStep(L1=True, lam=lam)
        ...
        if batchNum % 500 == 0:
            ...
            save_path = f"../WeightImages/L1/{filename}"
